...
import static com.example.ikonw2.R.drawable.button_art;
import static com.example.ikonw2.R.drawable.button_art_del;
import static com.example.ikonw2.R.drawable.button_chuangye;
import static com.example.ikonw2.R.drawable.button_chuangye_del;
import static com.example.ikonw2.R.drawable.button_competition;
import static com.example.ikonw2.R.drawable.button_competition_del;
import static com.example.ikonw2.R.drawable.button_computer;
import static com.example.ikonw2.R.drawable.button_computer_del;
import static com.example.ikonw2.R.drawable.button_economic;
import static com.example.ikonw2.R.drawable.button_economic_del;
import static com.example.ikonw2.R.drawable.button_english;
import static com.example.ikonw2.R.drawable.button_english_del;
import static com.example.ikonw2.R.drawable.button_exhibition;
import static com.example.ikonw2.R.drawable.button_exhibition_del;
import static com.example.ikonw2.R.drawable.button_lecture;
import static com.example.ikonw2.R.drawable.button_lecture_del;
import static com.example.ikonw2.R.drawable.button_literature;
import static com.example.ikonw2.R.drawable.button_literature_del;
import static com.example.ikonw2.R.drawable.button_movie;
import static com.example.ikonw2.R.drawable.button_movie_del;
import static com.example.ikonw2.R.drawable.button_pe;
import static com.example.ikonw2.R.drawable.button_pe_del;
import static com.example.ikonw2.R.drawable.button_performance;
import static com.example.ikonw2.R.drawable.button_performance_del;
import static com.example.ikonw2.R.drawable.button_practice;
import static com.example.ikonw2.R.drawable.button_practice_del;
import static com.example.ikonw2.R.drawable.button_sci;
import static com.example.ikonw2.R.drawable.button_sci_del;
import static com.example.ikonw2.R.drawable.button_volunteer;
import static com.example.ikonw2.R.drawable.button_volunteer_del;
import static com.example.ikonw2.R.drawable.button_xsj;
import static com.example.ikonw2.R.drawable.button_xsj_del;
...
public class LabelForEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setlabelforevent);
                ...
                if(clickNum > 21 && clickNum < 27 ) //活动形式标签被点击
                {
                    ...
                    if(activityCount < 1) //此刻还未选择活动形式标签,有点击应该是添加标签
                    {
                        ...
                        if(activityLabel[activityNum]){//所点击的是已经被选中的标签
                            ...
                            activityCount--;
                            ImageButton formerBtn = (ImageButton)findViewById(ButtonId[clickNum]);
                            formerBtn.setImageDrawable(getDrawable(unchoosedImage[activityNum]));
                        }
                        else{//所点击的是未被选中的标签，则删除原来选中的标签，选中这个点击的标签
